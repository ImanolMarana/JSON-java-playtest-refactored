...
public class Cookie {
    ...
    public static String toString(JSONObject jo) throws JSONException {
        ...
        String value = jo.optString("value", "").trim();
        ...
        for (String key : jo.keySet()) {
            ...
            appendAttribute(jo, sb, key);
        }

        return sb.toString();
    }

    private static void appendAttribute(JSONObject jo, StringBuilder sb, String key) throws JSONException {
