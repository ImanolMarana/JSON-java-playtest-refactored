...
// Emit content in body
    ...
    public static String toString(JSONObject jo) throws JSONException {
        ...
        if (ja == null) {
            ...
            appendChildren(ja, sb, tagName);
        }
        return sb.toString();
    }

    private static void appendAttributes(JSONObject jo, StringBuilder sb) throws JSONException {
        // Don't use the new entrySet API to maintain Android support
        for (final String key : jo.keySet()) {
    ...
    private static void appendChildren(JSONArray ja, StringBuilder sb, String tagName) throws JSONException {
        sb.append('>');
